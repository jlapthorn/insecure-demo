...
| # | App | Image | Notable CVEs | Security Misconfigurations | ACS Policies Triggered |
|---|-----|-------|-------------|---------------------------|----------------------|
| 4 | `vuln-spring4shell` | `spring-core-rce-2022-22965:latest` | **CVE-2022-22965 (Spring4Shell)**, CVE-2022-22963 | Run as root, `latest` tag, writable root filesystem | Spring4Shell, Latest Tag, Fixable CVEs, Run as Root |
...
| 13 | `vuln-kubectl` | `bitnami/kubectl:1.23` | Kubectl/Go CVEs from old version | `cluster-admin` ClusterRoleBinding, automounted SA token, run as root | RBAC Over-Privilege, Cluster Admin Binding, Fixable CVEs, Run as Root |
...
| | Spring4Shell (CVE-2022-22965) | `vuln-spring4shell` |
